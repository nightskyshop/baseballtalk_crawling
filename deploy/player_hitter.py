...
requests.post("https://baseballtalk.site/hitter?flag=start", json={})
...
for team in range(1, 11):
    ...
    for i in range(1 if len(btns) > 1 else 0, len(btns)-1 if len(btns) > 1 else 1):
        ...
        for i in range(1, len(trs) + 1):
            ...
            requests.post("https://baseballtalk.site/hitter?flag=none", json=data)
...
requests.post("https://baseballtalk.site/hitter?flag=end", json=data)
