...
requests.post("http://localhost:8080/pitcher?flag=start", json={})
...
for team in range(1, 11):
    ...
    for i in range(1 if len(btns) > 1 else 0, len(btns)-1 if len(btns) > 1 else 1):
        ...
        for i in range(1, len(trs) + 1):
            ...
            requests.post("http://localhost:8080/pitcher?flag=none", json=data)
...
requests.post("http://localhost:8080/pitcher?flag=end", json=data)
